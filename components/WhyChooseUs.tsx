  ...
  return (
    <section id="why-choose-us" className="section bg-[var(--color-primary)]/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[var(--color-text-light)]">
        ...
        >
          {reasons.map((reason, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="p-12 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.05)] rounded-2xl hover:border-[var(--color-accent)]/50 hover:bg-[rgba(255,255,255,0.05)] transition-all duration-300 group flex flex-col items-center text-center h-full"
            >
